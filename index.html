...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/0i9FhQwdDycd.css">
    <script type="module" src="js/ZEbTzhaU3WrH.js"></script>
  </head>
    ...
    <div class="Parallax">
      <div class="Parallax_Scroll">
        <div class="Parallax_Preserve Scene Scene-1">
          ...
          <h1 class="Title">Mars Uçagı<br>Görevi</h1>
          <p class="SubTitle">by Emirhan</p>
          <p class="Lead">Mars Orbiter'in lansmandan Mars Orbit'e yolculuğu
          </p>
        ...
        <div class="Parallax_Preserve Scene Scene-2">
          ...
          <p>The Mars Orbiter Mission (MOM), commonly referred to as Mangalyaan-1, is a space probe launched by the Indian Space Research Organization (ISRO) on November 5, 2013. The indigenously-built space probe, which is India's first interplanetary mission, has been in the Martian orbit since September 24, 2014. The mission is aimed to explore Mars surface features, morphology, mineralogy and Martian atmosphere.</p>
          <p>Once India decided to go to Mars, ISRO had no time to lose as the nearest launch window was only a few months away and it could not afford to lose the chance, given the next launch would present itself after over 780 days. Thus, mission planning, manufacturing the spacecraft and the launch vehicle and readying the support systems took place swiftly.</p>
          ...
          <svg class="Svg Svg-trajectory" viewBox="40 40 920 920" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
              ...
              <lineargradient id="s-trajectory-pathEarthFadeGradient">
                <stop offset="10%" stop-color="#300361"/>
                <stop offset="80%" stop-color="#300361" stop-opacity="0.5"/>
                <stop offset="100%" stop-color="#300361" stop-opacity="0"/>
              </lineargradient>
              ...
              <lineargradient id="s-trajectory-pathMarsFadeGradient">
                <stop offset="0%" stop-color="#300361"/>
                <stop offset="50%" stop-color="#300361" stop-opacity="0.5"/>
                <stop offset="100%" stop-color="#300361" stop-opacity="0"/>
              </lineargradient>
              ...
              <lineargradient id="s-trajectory-pathSpacecraftFadeGradient">
                <stop offset="0%" stop-color="#300361"/>
                <stop offset="50%" stop-color="#300361" stop-opacity="0"/>
              </lineargradient>
            </defs>
          ...
          <h2>Launch</h2>
          <p>MOM was launched aboard PSLV C-25, which was an XL variant of the PSLV, one of world's most reliable launch vehicles. The XL variant was earlier used to launch Chandrayaan (2008), GSAT-12 (2011) and RISAT-1 (2012).</p>
        </div>
        ...
        <div class="Parallax_Preserve Scene Scene-4">
          <h2>Spacecraft</h2>
          <p>Based on the I-1-K satellite bus of ISRO that has proved its reliability over the years in Chandrayaan-1 and the IRS and INSAT series of satellites, the MOM spacecraft carries 850 kg of fuel and following 5 science payloads:</p>
          <ul>
        ...
        <div class="Parallax_Preserve Scene Scene-5">
            ...
            <div class="Parallax_Layer Parallax_Layer-moiFg" style="--t: -1;">
              ...
              <div class="moiText moiText-1">
                <h2>Getting into Martian orbit</h2>
              </div>
              <div class="moiText moiText-2">
                <h3>Re-orient Spacecraft</h3>
                <p>MOM is reoriented to align the thrust vector, before firing the engines, to reduce the velocity.</p>
              </div>
              <div class="moiText moiText-3">
                <h3>Engine Firing</h3>
                <div class="moiText_Ticker">
                  <p class="moiText_TickerItem">The 440 N liquid Engine and 8 number of 22 N thrusters fire, imparting braking velocity of 1098.7 m/s.</p>
                  <p class="moiText_TickerItem">Burn starts when MOM is speeding at 5.127 km/s relative to Mars at an altitude of 1847 km from Mars.</p>
                  <p class="moiText_TickerItem">Nominally the burn ends in 24 minutes at an altitude of 973 km and a velocity of 4.316 km/s.</p>
              ...
              <div class="moiText moiText-4">
                <h3>The communication blackout</h3>
                <div class="moiText_Ticker">
                  <p class="moiText_TickerItem">The radio link between MOM and Ground station gets blocked by Mars.</p>
        ...
        <div class="Parallax_Preserve Scene Scene-6">
          <div class="Credit">
            ...
            <h2 class="Credit_Head">
              ...
              by <a class="Credit_Link" href="https://github.com/avisek" target="_blank" tabindex="-1">Avisek Das</a>
            </h2>
